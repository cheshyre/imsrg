...
class ReadWrite
{
 ...
 public:
   ...
   void ReadBareTBME_np_Darmstadt( std::string filename, Operator& Hbare, int E1max, int E2max, int lmax, int Jmax=-1);
   template<class T> void ReadBareTBME_Darmstadt_from_stream( T & infile, Operator& Hbare, int E1max, int E2max, int lmax);
   template<class T> void ReadBareTBME_np_Darmstadt_from_stream( T & infile, Operator& Hbare, int E1max, int E2max, int lmax, int Jmax);
...
//   void Store_Darmstadt_3body( std::vector<float>& ThreeBME, Operator& Hbare, int E1max, int E2max, int E3max);
   ...
   void WriteMScheme0B(std::string filename_prefix, Operator& Op);
   void WriteMScheme1B(std::string filename_prefix, Operator& Op);
   void WriteMScheme2B(std::string filename_prefix, Operator& Op);
   void WriteMSchemeBasis(std::string filename_prefix, Operator& Op);
   void WriteMSchemeFull(std::string filename_prefix, Operator& Op);
